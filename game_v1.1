...
int boss_var = 1, h = 1,hp = 20,hp_inimigo = 10,countdown = 3,inimigo_hp = 1,batalha_var = 1, batalha_var_2 = 1, batalha_var_3 = 1;
...
void personagem()
{
    ...
    int x,a,d=2,cx[300]={2,2},cy[300]={2,2},t=1,fase=1;
    char tecla='a';
    char run;
    gotoxy(2,2);
    printf("%c",219);
    ...
    while(tecla != 's')
    {
        ...
        //Ativador boss
         if(boss_var == 1){
            if(cy[0]==9){
                if(cx[0]>=60 && cx[0]<=70){hp_inimigo = 20; boss(); boss_var == 0;}
            }
         }
            if(cx[0]== 30 ){
                    if(cy[0] == 12){
...
void inimigo_atk_1()
{
    ...
    printf("           -^^^/    /|____");
    gotoxy(49,12);
    printf(" <%c________%c_______/      %c",92,92,92);
    gotoxy(49,13);
    printf(" <|___________|        |  |");
    gotoxy(49,14);
    printf(" </           |        |  |");
...
void inimigo_atk_2()
{
    ...
    printf(" | |       -^^^/    /|____");
    gotoxy(49,12);
    printf("  @________%c_______/      %c",92,92);
    gotoxy(49,13);
    printf("  @___________|        |  |");
    gotoxy(49,14);
    printf("  8           |        |  |");
